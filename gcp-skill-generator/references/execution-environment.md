...
2. [Idempotent Install Philosophy](#2-idempotent-install-philosophy)
3. [Phase 1: Probe — Detect Existing gcloud](#3-phase-1-probe--detect-existing-gcloud)
4. [Phase 2: Install — Idempotent Multi-Path Install](#4-phase-2-install--idempotent-multi-path-install)
5. [Phase 3: Verify — Post-Install Validation](#5-phase-3-verify--post-install-validation)
6. [Phase 4: Auth — Idempotent Auth Setup](#6-phase-4-auth--idempotent-auth-setup)
7. [Phase 5: Components — Idempotent Component Management](#7-phase-5-components--idempotent-component-management)
8. [Docker gcloud (Zero-Install Fallback)](#8-docker-gcloud-zero-install-fallback)
...
> **Full reference**: [docker-gcloud-setup.md](docker-gcloud-setup.md)

(Key points only — complete Docker wrapper script, alias setup, and troubleshooting in linked file.)

---

## 9. JIT Python SDK (Primary) & Go SDK (Secondary)

> **Full reference**: [jit-sdk-setup.md](jit-sdk-setup.md)

(Python SDK and Go SDK setup, examples, and decision matrix in linked file.)
